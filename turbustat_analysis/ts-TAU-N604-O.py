...
name_file = 'TAU-N604-O-mod.fits'
name_res = 'TAU-N604-O'
flux_map = 'TAURUS-604-O-Flux.fits'
...
ax.plot(xgrid,(10**(4.28))*(xgrid**pspec.slope), color = 'r', alpha = 0.85, linewidth = 2.5)
...
axx.plot(xgrid,(10**(-1.13))*(xgrid**dvar.slope), color = 'r', alpha = 0.75, linewidth = 2.5)
...
get_ipython().system('jupyter nbconvert --to script --no-prompt ts-TAU-N604-O.ipynb')
