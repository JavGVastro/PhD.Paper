...
model.set_param_hint("sig2", value=0.5 * B.max(), min=0.01 * B.max(), max=0.75 * B.max())

# m between 1/2 and 5/3
model.set_param_hint("m", value=1.0, min=0.1, max=2.0)
...
get_ipython().system('jupyter nbconvert --to script --no-prompt ci-TAU-N604-O.ipynb')
