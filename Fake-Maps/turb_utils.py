"""
Some functions to extend turbustat

William Henney 2021

Lightly edited versions of functions from turbustat.simulator to
generate fields that are uncorrelated at large scales.
"""
...
def make_extended(
    ...
    Adapted from https://github.com/Astroua/TurbuStat/blob/master/turbustat/simulator.
    WJH: Added tapering of the power law at large scales.

    Previously adapted from https://github.com/keflavich/image_registration. Added ability
    ...
    correlation_length : float, optional
        Characteristic length scale of fluctuations in pixel units.  Power law
        is exponentially tapered for lengths longer than this
