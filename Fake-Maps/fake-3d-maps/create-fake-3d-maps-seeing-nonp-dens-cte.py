...
cube_nt.write('cube_fits//cube_nt_dens_cte_s0_np.fits', format='fits')  
...
cube.write('cube_fits//cube_dens_cte_s0_np.fits', format='fits')  
...
jsonfilename = "vmaps_3d_s0_np_dens_cte.json"
...
fig.savefig("fake-3d-seeing-nonp-dens-cte-thumbnails.pdf")


get_ipython().system('jupyter nbconvert --to script --no-prompt create-fake-3d-maps-seeing-nonp-dens-cte.ipynb')
