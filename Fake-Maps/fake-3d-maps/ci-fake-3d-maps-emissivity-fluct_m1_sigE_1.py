...
data_in = json.load(open("data_ems_fluct_sigE_1.json"))
...
get_ipython().system('jupyter nbconvert --to script --no-prompt ci-fake-3d-maps-emissivity-fluct_m1_sigE_1.ipynb')
