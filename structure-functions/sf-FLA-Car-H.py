...
r0 = np.interp(sig2[1:35], b2[1:35], s)
r0


r1 = np.interp(sig[1:35], b2[1:35], s)
r1


r2 = np.interp(2*sig2[1:35], b2[1:35], s)
r2
...
get_ipython().system('jupyter nbconvert --to script --no-prompt sf-FLA-Car-H.ipynb')
