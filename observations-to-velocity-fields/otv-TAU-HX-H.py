...
data_file = 'TAURUS-HX-Ha-'


name_export='TAU-HX-H'
...
mI=(data.I>data.I.mean()+0.5*data.I.std())&(data.Y<190)
data=data[mI]
...
get_ipython().system('jupyter nbconvert --to script --no-prompt otv-TAU-HV-H.ipynb')
