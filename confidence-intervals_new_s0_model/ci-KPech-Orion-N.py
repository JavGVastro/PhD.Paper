...
model.set_param_hint("sig2", value=0.5 * B[to_fit].max(), min=0.25 * B[to_fit].max(), max=2 * B.max())
...
get_ipython().system('jupyter nbconvert --to script --no-prompt ci-KPech-Orion-N.ipynb')
